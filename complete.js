...
function test()
{
	...
	console.log("HK answer " + tsp_hk(graph)); 
	console.timeEnd("HK graph of size 3");
	graph = rand(4);
	console.time("HK graph of size 4");
	console.log("HK answer " + tsp_hk(graph)); 
	console.timeEnd("HK graph of size 4");
	graph = [[0, 1, 2, 3, 4],
		[1, 0, 5, 2, 4],
		[2, 5, 0, 1, 2],
		[3, 2, 1, 0, 3],
	...
	graph = rand(6);
	console.time("SLS graph of size 6");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("SLS graph of size 6");
	console.time("HK graph of size 6");
	console.log("HK answer " + tsp_hk(graph)); 
	console.timeEnd("HK graph of size 6");
	...
	graph = rand(13);
	console.time("HK graph of size 13");
	console.log("HK answer " + tsp_hk(graph)); 
	console.timeEnd("HK graph of size 13");
	graph = rand(14);
	console.time("HK graph of size 14");
	console.log("HK answer " + tsp_hk(graph)); 
	console.timeEnd("HK graph of size 14");
/*	graph = rand(15);
	console.time("HK graph of size 15");
	console.log("HK answer " + tsp_hk(graph)); 
	console.timeEnd("HK graph of size 15");
*/
	...
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("SLS graph of size 3800");
}
