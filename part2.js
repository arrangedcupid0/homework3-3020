...
function test()
{
	var graph = [[0, 2, 2],
			[2, 0, 1],
			[2, 1, 0]];
	console.time("graph of size 3");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 3");
	graph = [[0, 1, 2, 3, 4],
		[1, 0, 5, 2, 4],
		[2, 5, 0, 1, 2],
		[3, 2, 1, 0, 3],
		[4, 4, 2, 3, 0]];
	console.time("graph of size 5");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 5");
	graph = [[0, 1, 2, 3, 4, 5, 6],
		[1, 0, 7, 12, 5, 9, 21],
		[2, 7, 0, 14, 8, 3, 1],
		[3, 12, 14, 0, 17, 6, 12],
		...
		[5, 9, 3, 6, 13, 0, 7],
		[6, 21, 1, 12, 3, 7, 0]];
	console.time("graph of size 7");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 7");
	...
	console.time("graph of size 12");
	console.log("SLS answer " + tsp_ls(graph));
	console.timeEnd("graph of size 12");
	...
	console.time("graph of size 18");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 18");
	...
	//were a pain to make.
	graph = rand(120);
	console.time("graph of size 120");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 120");
	graph = rand(260);
	console.time("graph of size 260");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 260");
	graph = rand(600);
	console.time("graph of size 600");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 600");
	graph = rand(1000);
	console.time("graph of size 1000");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 1000");
	graph = rand(2000);
	console.time("graph of size 2000");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 2000");
	graph = rand(3000);
	console.time("graph of size 3000");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 3000");
	graph = rand(3600);
	console.time("graph of size 3600");
	console.log("SLS answer " + tsp_ls(graph)); 
	console.timeEnd("graph of size 3600");
}
